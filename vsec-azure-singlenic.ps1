...
# Mandatory   : Yes
# Valid values: CIDR notation
$Subnet1Prefix = "10.5.1.0/24"
$Subnet2Prefix = "10.5.2.0/24"
$Subnet3Prefix = "10.5.3.0/24"

# Description : The gateway address on the external subnet
# Mandatory   : Yes
# Valid values: IPv4 address
$Subnet1PrivateAddress = "10.5.1.10"
...
$GatewayName = "vsecgwr7730"
# Description : The size of the gateway VM
# Mandatory   : Yes
$GatewayVMSize = "Standard_D2_v2"
...
Add-AzureRmRouteConfig `
    ...
    -NextHopType Internet | Set-AzureRmRoutetable
